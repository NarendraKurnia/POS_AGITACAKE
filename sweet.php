        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/Putu_Cakes.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Putu Cakes</p>
                      <p class="card-title">Kategori : Sweet</p>
                      <p class="card-text"><strong>Rp14.000</strong></p>
                    </div>
