...
<head>
    ...
    <title>Collaboration | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/vanillacaramel.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Vanilla Caramel</p>
                      <p class="card-title">Kategori : Collaboration</p>
                      <p class="card-text"><strong>Rp16.500</strong></p>
                    </div>
                  </div>
             </div>
            <!-- end produk -->
