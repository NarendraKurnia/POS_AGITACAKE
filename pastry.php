...
<head>
    ...
    <title>Pastry | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/garliccreamcroissant.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Garlic Cream Croissant</p>
                      <p class="card-title">Kategori : Pastry</p>
                      <p class="card-text"><strong>Rp39.000</strong></p>
                    </div>
                  </div>
             </div>
            <!-- end produk -->
