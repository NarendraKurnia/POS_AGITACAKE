...
<div class="container my-5">
        <h4 class="mb-4">Snack Tray (New Look) </h4>
    </div>  
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/Paket_Tampah_A.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Paket Tampah A</p>
                      <p class="card-title">Kategori : Snack Tray (New Look)</p>
                      <p class="card-text"><strong>Rp349.000</strong></p>
                    </div>
            ...
            <!-- end produk -->
             ...
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/Paket_Tampah_A.jpg" class="card-img-top" alt="...">
                    <div class="card-body">Paket_Tampah_A.jpg
                      <p class="card-title">Paket Tampah A</p>
                      <p class="card-title">Kategori : Snack Tray (New Look)</p>
                      <p class="card-text"><strong>Rp349.000</strong></p>
                    </div>
