Kategori<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Pudding | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/double-choco.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Double Choco Pudding</p>
                      <p class="card-title">Kategori : Pudding</p>
                      <p class="card-text"><strong>Rp35.000</strong></p>
                    </div>
