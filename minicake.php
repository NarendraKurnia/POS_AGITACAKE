...
<head>
    ...
    <title>Mini Cake | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/triplechocolate.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Triple Chocolate</p>
                      <p class="card-title">Kategori : Mini cake</p>
