...
<head>
    ...
    <title>Bakery | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/roti-butter-abon.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Roti Butter Abon</p>
                      <p class="card-title">Kategori : Bakery</p>
                      <p class="card-text"><strong>Rp11.500</strong></p>
                    </div>
