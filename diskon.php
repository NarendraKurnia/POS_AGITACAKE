...
<head>
    ...
    <title>Diskon | Agita Cakes</title>
    <!-- icon -->
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/sosissolo.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Sosis Solo</p>
                      <p class="card-title">Categorie : Traditional</p>
                      <p class="card-text"><strong>Rp4.500</strong></p>
                      <p>
                        <span class="text-secondary"><strike>Rp9.000</strike></span>
                        <span class="text-danger">50%</span>
                      </p>
                    </div>
                    <div class="my-1 card-diskondelete">
                        <button type="submit" class="btn btn-primary shadow-none"><i class="bi bi-trash3-fill"></i></button>
                      </div>
                  </div>
             </div>
            <!-- end produk -->
