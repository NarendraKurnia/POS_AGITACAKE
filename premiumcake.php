...
<head>
    ...
    <title>Premium Cake | Agita Cakes</title>
    <!-- icon -->
...
<div class="menu-container-2 daftar-menu">
    ...
    <!-- Modal -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/contoh-cake.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Strawbery crunch chiz</p>
                      <p class="card-title">Kategori : Premium cake</p>
                      <p class="card-text"><strong>Rp13.500</strong></p>
                  </div>
          ...
          <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="takeAwayModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="window.location.href='premiumcake.php'">Edit produk</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    </div>
                </div>
            </div>
