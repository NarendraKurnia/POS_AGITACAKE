...
<head>
    ...
    <title>Whoole Cake | Agita Cakes</title>
    <!-- icon -->
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="categore" placeholder="Kategori">
                            </div>
                            <div class="mb-3">
        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/wholecake.jpeg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Personal Carramel Macchiato cake</p>
                      <p class="card-title">Kategori : Whoole cake</p>
                      <p class="card-text"><strong>Rp300.000</strong></p>
                    </div>
