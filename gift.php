        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/minichoug.png" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Mini Choux</p>
                      <p class="card-title">Kategori : Gift</p>
                      <p class="card-text"><strong>Rp130.000</strong></p>
                    </div>
                  </div>
             </div>
            <!-- end produk -->
             ...
             <div class="col-md-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <p class="card-title">Mini Choux</p>
                      <p class="card-title">Kategori : Gift</p>
                      <p class="card-text"><strong>Rp.130.000</strong></p>
                    </div>
                  </div>
             </div>
            <!-- end produk -->
