...
<head>
	...
	<title>Ringkasan Pesanan | Agita Cakes</title>
	<!-- icon -->
...
">
<main>
	<h1 class="mt-4 mb-5 checkout-title">Ringkasan Pesanan</h1>
	<hr>
	 <div class="mt-5 mb-4 card-booked">
            ...
            <div class="d-flex justify-content-between">
                <p class="fw-bold">Metode Pembayaran :
                	<img src="images/logo-qris2.png" style="width:140px;" alt=""></p>
            </div>
        </div>
         <div class="my-1 card-print">
            <button type="submit" class="btn btn-primary shadow-none"><i class="bi bi-printer-fill"></i></button>
          </div>
        <button class="btn btn-cancel w-100 btn-cancel-ringkasan" onclick="window.location.href='index.php'">Kembali ke Beranda</button>
    </div>
</main>
