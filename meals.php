        ...
        <!-- end modal -->
         ...
         <div class="row">
            <!-- produk -->
             <div class="col-md-4">
                <div class="card mb-3">
                    <img src="images/ANEKA_KLETIKAN_POUCH.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <p class="card-title">Aneka Kletikan Pouch</p>
                      <p class="card-title">Kategori : Meals</p>
